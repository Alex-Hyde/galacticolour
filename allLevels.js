function createLevelList() {
    ...
    level3 = new Level([new Wave([[yellowTracker, 3], [Mob1, 9], [Mob2, 3], [Mob3, 2]], 17, 1500), new Wave([[Mob1, 5], [Mob2, 2], [Mob3, 6]], 13, 1500)], 3);
    level5 = new Level([new Wave([[yellowTracker, 3], [redTracker, 3], [purpleTracker, 3]], 9, 1500)], 5);
    return [level1, level2, level3, [], level5];
}
