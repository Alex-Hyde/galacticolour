function createLevelList() {
    level1 = new Level([new Wave([[Mothership, 5], [Mob2, 7], [Mob3, 10]], 22, 1500), new Wave([[Mob1, 3], [Mob2, 3], [Mob3, 6]], 12, 1500)], 1);
    level2 = new Level([new Wave([[Mob2, 7], [Mob3, 10]], 17, 1500), new Wave([[Mob1, 3], [Mob2, 3]], 6, 1500)], 2);
    level3 = new Level([new Wave([[yellowLeftTank, 3], [redTracker, 9], [Mob2, 0], [Mob3, 0]], 12, 1500), new Wave([[Mob1, 5], [Mob2, 2], [Mob3, 6]], 13, 1500)], 3);
